...
//This script adds fields to the Inspector of your GameObjects with the MyScript script attached. 
//Edit the fields to change the layer and order number each Sprite belongs to.
// Custom Editor using SerializedProperties.
[CustomEditor(typeof(RenderObject))]
public class RenderObjectSelection : Editor
{
